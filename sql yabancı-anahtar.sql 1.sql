...
CREATE TABLE IF NOT EXISTS `eser` (
  ...
  `eser_sanatci` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`sira`),
  KEY `FK_eser_eser` (`eser_sanatci`),
  CONSTRAINT `FK_eser_eser` FOREIGN KEY (`eser_sanatci`) REFERENCES `eser` (`sira`) ON DELETE NO ACTION ON UPDATE NO ACTION
